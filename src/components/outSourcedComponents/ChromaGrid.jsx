    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex flex-col w-[300px] rounded-[20px] overflow-hidden border-2 transition-all duration-300 cursor-pointer bg-white/5 backdrop-blur-sm hover:bg-white/10"
          style={{
            "--card-border": c.borderColor || "transparent",
            borderColor: c.borderColor || "rgba(255,255,255,0.1)",
