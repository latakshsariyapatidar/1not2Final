      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12">
          <div className="p-6 bg-[#2B2B2B] rounded-lg border border-[#3C3C3C]">
            <h3 className="text-2xl font-semibold mb-6 text-[#00B2A9]">Contact Information</h3>
          ...
          <div className="p-6 bg-[#2B2B2B] rounded-lg border border-[#3C3C3C]">
            <h3 className="text-2xl font-semibold mb-6 text-[#00B2A9]">Ready to Create?</h3>
            ...
            <button className="bg-[#00B2A9] hover:bg-[#FF6B35] text-[#EAEAEA] px-6 py-3 rounded-lg font-semibold transition-colors duration-300">
              Start Your Project
            </button>
          </div>
        </div>
