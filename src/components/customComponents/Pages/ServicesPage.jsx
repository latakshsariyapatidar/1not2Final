    ...
    <div className="w-full h-full p-8 pt-20 text-[#EAEAEA] overflow-y-auto">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          <div className="text-center p-6 border border-[#3C3C3C] bg-[#2B2B2B] rounded-lg hover:border-[#00B2A9] transition-colors duration-300">
            <h3 className="text-2xl font-semibold mb-4 text-[#00B2A9]">Film Production</h3>
            <p className="text-[#A0A0A0]">Complete film production services from concept to screen</p>
          </div>
          <div className="text-center p-6 border border-[#3C3C3C] bg-[#2B2B2B] rounded-lg hover:border-[#00B2A9] transition-colors duration-300">
            <h3 className="text-2xl font-semibold mb-4 text-[#00B2A9]">Post-Production</h3>
            <p className="text-[#A0A0A0]">Professional editing, VFX, and sound design</p>
          </div>
          <div className="text-center p-6 border border-[#3C3C3C] bg-[#2B2B2B] rounded-lg hover:border-[#00B2A9] transition-colors duration-300">
            <h3 className="text-2xl font-semibold mb-4 text-[#00B2A9]">Creative Direction</h3>
